...
<div class="px-4 pt-96">
    ...
    <div class="grid grid-cols-1 gap-6 mb-6 w-full xl:grid-cols-2 2xl:grid-cols-3">
        <x-card class="bg-gradient-to-r from-dark-800 to-dark-900 2xl:col-span-2">
        ...
        <x-card>
            ...
            <div class="flex justify-between items-center mb-4">
                <div>
                    ...
                    <span class="text-base font-normal text-gray-500">This is a list of latest country</span>
                </div>
                <div class="flex-shrink-0">
                    <a href="#" class="p-2 text-sm font-medium text-gray-900 rounded-lg hover:bg-gray-100">View
                        all</a>
                </div>
            </div>
            <!-- Table -->
                                            ...
                                            <svg class="w-4 h-4" viewBox="0 0 26 18" fill="none"
                                                ...
                                                <mask id="mask0" style="mask-type: alpha" maskUnits="userSpaceOnUse"
                                                    ...
                                                    <rect x="0.25" y="0.779053" width="25.2567" height="16.6429"
                                                        rx="1.75" fill="white" stroke="white" stroke-width="0.5" />
                                                </mask>
                                                <g mask="url(#mask0)">
                                        ...
                                        <td
                                            ...
                                            <svg class="w-4 h-4" viewBox="0 0 28 20" fill="none"
                                                ...
                                                <rect x="0.25" y="0.25" width="27.5" height="19.5" rx="1.75"
                                                    fill="white" stroke="#F5F5F5" stroke-width="0.5" />
                                                ...
                                                <defs>
                                                    <linearGradient id="paint0_linear_267_1444" x1="8" y1="4" x2="8"
